...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 10, 2023 at 04:45 AM
...
(1, 1, 3, 'rax', 'product dummy', NULL, '2023-09-09 14:19:28', '2023-09-09 15:52:23'),
(2, 1, 3, 'rex', 'ikan', NULL, '2023-09-09 14:19:28', '2023-09-09 14:19:28'),
...
--
ALTER TABLE `products`
  ADD CONSTRAINT `products_ibfk_1` FOREIGN KEY (`product_type_id`) REFERENCES `products` (`id`),
